 ...
 * 
 */
public class ExpandableListViewaAdapter1 extends BaseExpandableListAdapter {
	private Context context;
	private List<ProjectEntity> groupArray;// 组列表
	private List<List<ProjectEntity>> childArray;// 子列表

	public ExpandableListViewaAdapter1(Context context,
			List<ProjectEntity> groupArray, List<List<ProjectEntity>> childArray) {
	...
	public View getChildView(int groupPosition, int childPosition,
		...
		ProjectEntity entity = childArray.get(groupPosition).get(childPosition);
		holder.tvTitle.setText(entity.getProName());
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		group.tvTitle.setText(groupArray.get(groupPosition).getProName());
		group.tvMoney.setVisibility(View.GONE);
		return convertView;
	}
